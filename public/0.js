...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("b-card-text", [
        _c("p", [_vm._v("В приложении используются:")]),
        _vm._v(" "),
        _c("ul", [
          _c("li", [_vm._v("Laravel Framework 7.28.4")]),
          _vm._v(" "),
          _c("li", [_vm._v("PostgreSQL")]),
          _vm._v(" "),
          _c("li", [_vm._v("BootstrapVue")]),
          _vm._v(" "),
          _c("li", [_vm._v("Sweet Alert 2")]),
          _vm._v(" "),
          _c("li", [_vm._v("VueProgressBar")]),
          _vm._v(" "),
          _c("li", [_vm._v("vform")]),
          _vm._v(" "),
          _c("li", [_vm._v("Charts.js")])
        ]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
            "Данные по валютам загружаются с официального сайта Банка России (cbr.ru)."
          )
        ]),
        _vm._v(" "),
        _c("p", [
          _vm._v("Справочник валют заполняется консольной командой: "),
          _c("i", [_vm._v("php artisan currencies:get")]),
          _vm._v(".")
        ])
      ])
    ],
